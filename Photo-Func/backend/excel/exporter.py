...
from .entry_block import copy_row
from .image_handler import process_and_insert_images
from .entry_manager import prepare_entry_block, write_footers
...
def export_excel(sections, files):
    ...
    for section in sections:
        ...
        for entry in section.get("entries", []):
            ...
            # Move to next block based on fixed height
